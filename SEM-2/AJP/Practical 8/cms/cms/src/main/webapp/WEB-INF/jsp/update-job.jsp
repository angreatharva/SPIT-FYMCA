...
<body>
    <div class="container">
        <div class="dashboard">
            <a href="<c:url value='/jobs/update'/>" class="back-link">← Back to Job Selection</a>
            <h1 class="welcome-header">Update Job</h1>
            ...
            <form id="updateJobForm">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="company-name" name="companyName" value="${job.companyName}" required>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="salary" name="salary" value="${job.salary}" placeholder="e.g. $50,000 - $70,000 per year">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="requirements" name="requirements" required>${job.requirements}</textarea>
                </div>
                
                <div class="form-group">
                    <label for="expiry-date">Application Deadline</label>
                    <input type="date" id="expiry-date" name="expiryDate" value="${job.expiryDate}">
                </div>
